...
description: AstroJS plugin for automatic synchronization of admin polygons via WFS-T
status: migrated
...
- ✅ **True AstroJS Integration**: Runs as a native Astro integration in both development and production
