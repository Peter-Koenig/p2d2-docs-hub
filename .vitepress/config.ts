...
export default withMermaid(
    defineConfig({
        ...
        sitemap: {
            hostname: "https://doc.data-dna.eu",
        },
            ...
            pt: {
                ...
                themeConfig: {
                    nav: [
                        ...
                        {
                            text: "Estratégia",
                            link: "/pt/entwicklungsstrategie/",
                        },
                        {
                            text: "QA da Documentação",
                            link: "/pt/quality-overview",
                        },
                    ],
            ...
            fr: {
                ...
                themeConfig: {
                    nav: [
                        ...
                        {
                            text: "Stratégie",
                            link: "/fr/entwicklungsstrategie/",
                        },
                        {
                            text: "QA Documentation",
                            link: "/fr/quality-overview",
                        },
                    ],
            ...
            es: {
                ...
                themeConfig: {
                    nav: [
                        ...
                        {
                            text: "Estrategia",
                            link: "/es/entwicklungsstrategie/",
                        },
                        {
                            text: "QA de Documentación",
                            link: "/es/quality-overview",
                        },
                    ],
            ...
            ru: {
                ...
                themeConfig: {
                    nav: [
                        ...
                        {
                            text: "Стратегия",
                            link: "/ru/entwicklungsstrategie/",
                        },
                        {
                            text: "QA документации",
                            link: "/ru/quality-overview",
                        },
                    ],
        ...
        rewrites: {
            ...
            "administrationshandbuch/:path*":
                "de/administrationshandbuch/:path*",
